# This file is meant to reparse json data autogenerated from
# finalBoard.xml on https://codebeautify.org/xmltojson to
# work out some of the quirks inserted by the autogenerator.
